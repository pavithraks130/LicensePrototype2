...
namespace LicenseKey
{
    ...
    /// </summary>
    internal class CharacterDatatype : Datatype
    {
        private string dataValue; // the data value of this data type
                    ...
                    if (rcnt != 0)
                    {
                        ...
                        if (flgchk == false)
                            throw new ApplicationException(
                                "Please enter a token that will fit into the size to the specified token");
                        flgfound = true;
                    }
                    rcnt = 0;
                }
